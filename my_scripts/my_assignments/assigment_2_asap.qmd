...
# This function takes a data frame that has at least 3 columns, for the candidate (name and rate) and the prior, a number of trials N and a number of success s.
...
data_1
# Does A, or B, or C have a defect in the next shipment?  
