...
# the probability that the ML algorithm gives A given that A is true (that if A
# really made the product the ML shows A), which is 0.9
...
preds %>% ggplot(aes(x=L)) + 
  ...
  scale_x_continuous(limits = c(0,N), breaks = seq(0,N,100)) + 
  labs(x = "Number of Simulated L out of 1000",
       y = "Frequency", title = "Values obtained when sampling with
       the posterior") 
